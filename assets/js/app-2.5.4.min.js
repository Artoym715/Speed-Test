...
*/       
window.onload=function(){var X=document.getElementById("OpenSpeedTest-UI");if(X&&X.contentDocument&&X.contentDocument.documentElement){X.parentNode.replaceChild(X.contentDocument.documentElement,X)}ostOnload();OpenSpeedTest.Start()};
